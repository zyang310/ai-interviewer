...
// UpdateBanner notifies the user that a newer app release is available. There is
// no self-replacing updater, so Download opens the release (its .zip asset, or
// the release page as a fallback) in the browser for a manual install.
